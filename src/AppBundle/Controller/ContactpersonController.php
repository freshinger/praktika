 ...
 * Der Ansprechpartnercontroller kümmert sich um die CRUD (Create, Read, Update,
 * Delete) Funktionalität der Ansprechpartnerobjekte.
 * Ansprechpartner sind Firmen zugeordnet. 
 */
...
class ContactpersonController extends Controller {
    ...
    public function contactAction(Request $request, $id) {
        ...
        $form = $this->createForm('AppBundle\Form\AnsprechpartnerType', 
            $ansprechpartner);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $msg = "Der Ansprechpartner: " . $name 
                . " wurde erfolgreich in die Datenbank übertragen!";
